                    ...
                    <div class="row">
                            ...
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h2 class="product-title"><Link to="productfc86.html?ID=8">Sandal</Link></h2>
                            ...
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h2 class="product-title"><Link to="productc655.html?ID=7">Sandal</Link></h2>
                                    <div class="product-price">
                                        ₦5,000                                        </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h2 class="product-title"><Link to="product3439.html?ID=6">Sandal</Link></h2>
                                    <div class="product-price">
                                        ₦3,500                                        </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h2 class="product-title"><Link to="product5ced.html?ID=4">Sandal</Link></h2>
                                    <div class="product-price">
                                        ₦10,000                                        </div>
