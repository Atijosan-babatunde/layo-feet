            ...
            <div className="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav": false, "dots": false}'>
                <div className="intro-slide" style={{ backgroundImage: `url(${banner1})` }}>
                    <div className="container intro-content text-center">
                        ...
                        <Link to="/shop" className="btn btn-primary">Discover NOW</Link>
                    </div>
                </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><Link to="/product3">Layor's Feet White</Link></h3>
                                        <div class="product-price">
                                            &#8358;15,000                                            </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        ...
                                        <div class="product-action product-action-transparent">
                                            <Link to="/productd4" class="btn-product btn-cart"><span>add to cart</span></Link>
                                        </div>
                                    </figure>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><Link to="productc655.html?ID=7">Layor's Feet White</Link></h3>
                                            <div class="product-price">
                                                &#8358;5,000                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><Link to="product3439.html?ID=6">Layor's Feet Black</Link></h3>
                                            <div class="product-price">
                                                &#8358;3,500                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><Link to="product5ced.html?ID=4">Layor's Feet Black</Link></h3>
                                            <div class="product-price">
                                                &#8358;10,000                                            </div>
                                        </div>
                                    </div>
